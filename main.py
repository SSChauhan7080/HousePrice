...
app = Flask(__name__)
data = pd.read_csv('C:/Users/Saurabh Singh/OneDrive/Desktop/HP/HousePrice_Prediction-master/HousePrice_Prediction-master/final_dataset.csv')

pipe = pickle.load(open("C:/Users/Saurabh Singh/OneDrive/Desktop/HP/HousePrice_Prediction-master/HousePrice_Prediction-master/RidgeModel.pkl", 'rb'))
